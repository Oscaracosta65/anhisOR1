<?php
/**
 * LottoExpert.net — Oregon Megabucks Results Intelligence
 * Joomla 5.x + PHP 8.1+
 *
 * GAME: Oregon Megabucks
 * GAME ID: OR1
 * PICK: 6 main numbers (no bonus ball)
 * RANGE: 01–48
 * All six DB columns (first–sixth) are main balls.
 *
...
if (isset($stateName, $gName) && $stateName !== '' && $gName !== '') {
    ...
    $doc->setMetaData('description', 'Frequency, recency, and draw history analysis for ' . $stateName . ' ' . $gName . '. Review the most active numbers, quiet stretches, and full historical distribution across all 48 numbers before moving into SKAI analysis.');
}
...
/**
 * Pick 6: repeated-number check across all six main columns.
 */
...
/**
 * Pick 6: all six positions are main balls. Search all six columns.
 */
 ...
 * All 6 positions are main balls — no bonus distinction.
 * --------------------------------------------------------------------------
 */
$drawHistoryRows = [];
...
$jsonLdPage = json_encode([
    ...
    '@type'       => 'WebPage',
    'name'        => (isset($stateName, $gName) ? $stateName . ' ' . $gName . ' Results Intelligence' : 'Lottery Results Intelligence') . ' | LottoExpert.net',
    'description' => 'Historical frequency, recency, and draw analysis for ' . (isset($stateName, $gName) ? $stateName . ' ' . $gName : 'Oregon Megabucks') . '. Pick 6 game, numbers 01 to 48.',
      ...
      <div class="skai-hero-top">
        ...
        <div class="skai-hero-copy">
          ...
          <div class="skai-hero-actions" aria-label="Primary actions">
            <a class="skai-btn skai-btn--primary" href="/picking-winning-numbers/artificial-intelligence/skai-lottery-prediction?gameId=OR1">
              Open SKAI Analysis
            </a>
            <a class="skai-btn skai-btn--secondary" href="/picking-winning-numbers/artificial-intelligence/ai-powered-predictions?game_id=OR1">
              AI Predictions
            </a>
          ...
          <div class="skai-advanced-links" aria-label="Advanced tools">
            <a class="skai-mini-link" href="/picking-winning-numbers/artificial-intelligence/skip-and-hit-analysis?game_id=OR1">Skip &amp; Hit Analysis</a>
            <a class="skai-mini-link" href="/picking-winning-numbers/artificial-intelligence/markov-chain-monte-carlo-mcmc-analysis?game_id=OR1">MCMC Markov Analysis</a>
            <a class="skai-mini-link" href="/picking-winning-numbers/artificial-intelligence/oregon-megabucks-heatmap-analysis">Heatmap Analysis</a>
          </div>
        </div>
  ...
  <section class="skai-strip" aria-label="Key takeaways">
    ...
    <article class="skai-stat">
      ...
      <div class="skai-stat-body">
        ...
        <div class="skai-stat-note">Number of drawings currently loaded for this analysis page view.</div>
      </div>
    </article>
  </section>
  ...
  <section id="frequency-deep-dive" class="skai-section" aria-labelledby="frequency-title">
    <div class="skai-section-head">
      <div>
        ...
        <p class="skai-section-sub">
          Move from summary to full reference. The left panel shows the complete main-number distribution across all values 01&ndash;48. The right panel shows the recency distance for each number — how many drawings ago each value last appeared.
        </p>
      </div>
    </div>
      ...
      <div class="skai-two-col">
        <div class="skai-card">
          <div class="skai-card-head skai-card-head--horizon">
            ...
            <span class="skai-card-sub">All values 01&ndash;48 across the last <?php echo (int) $nodCurrent; ?> drawings</span>
          </div>
          <div class="skai-card-body">
            <div class="skai-chart-shell">
        ...
        <div class="skai-card">
          <div class="skai-card-head skai-card-head--ember">
            ...
            <span class="skai-card-sub">Distance since last appearance for each main number (01&ndash;48)</span>
          </div>
          <div class="skai-card-body">
            <div class="skai-chart-shell">
              <div class="skai-chart-frame skai-chart-frame--tall">
  ...
  <section id="tables" class="skai-section" aria-labelledby="tables-title">
    ...
    <div class="skai-section-body">
      <div class="skai-card">
        <div class="skai-card-head skai-card-head--horizon">
          Main numbers table
          <span class="skai-card-sub">Exact counts and recency for values 01&ndash;48 — Pick 6, all positions included</span>
        </div>
      ...
      <div class="skai-tool-grid">
        <article class="skai-tool">
          ...
          <div class="skai-tool-body">
            ...
            <a class="skai-tool-cta" href="/picking-winning-numbers/artificial-intelligence/skai-lottery-prediction?gameId=OR1">Open SKAI Analysis</a>
          </div>
        </article>
        ...
        <article class="skai-tool">
          ...
          <div class="skai-tool-body">
            ...
            <a class="skai-tool-cta" href="/picking-winning-numbers/artificial-intelligence/ai-powered-predictions?game_id=OR1">Open AI Predictions</a>
          </div>
        </article>
        ...
        <article class="skai-tool">
          ...
          <div class="skai-tool-body">
            ...
            <a class="skai-tool-cta" href="/picking-winning-numbers/artificial-intelligence/skip-and-hit-analysis?game_id=OR1">Open Skip &amp; Hit</a>
          </div>
        </article>
      </div>

      <div class="skai-utility-grid">
        <a class="skai-utility-link" href="/picking-winning-numbers/artificial-intelligence/markov-chain-monte-carlo-mcmc-analysis?game_id=OR1">MCMC Markov Analysis</a>
        <a class="skai-utility-link" href="/picking-winning-numbers/artificial-intelligence/oregon-megabucks-heatmap-analysis">Heatmap Analysis</a>
  ...
  <section class="skai-section" aria-labelledby="method-title">
    ...
    <div class="skai-section-body">
      <div class="skai-method-note">
        <strong>Interpretation guidance:</strong> Frequency, recency, and spacing can provide useful context for reviewing draw history, but they should be treated as descriptive signals rather than guarantees. The purpose of this page is to make the recent behavior of the game easier to understand, compare, and carry into deeper SKAI analysis. Oregon Megabucks is a Pick 6 game drawing six numbers from 01 to 48. All six positions are equal main balls; there is no separate bonus or special number in this game.
      </div>
    </div>
  </section>
